...
# pdf 경로
pdf_path="C:\\datapare\\CL\\0614.pdf"
# excel 경로
excel_path="C:\\datapare\\CL\\0614.xlsx"
...
top=(20.35*72)/25.4
left=(65.80*72)/25.4
width=(140.35*72)/25.4
height=(275.75*72)/25.4

col1=(12.75*72)/25.4+left
col2=(17.12*72)/25.4+col1
col3=(80.82*72)/25.4+col2
col4=(9.13*72)/25.4+col3
col5=(7.23*72)/25.4+col4
...
def remo(df_mk, df_del_len):
    ...
    for i in range(df_del_len, df_mk_len+df_del_len):
        ...
        if (df_mk[col3][i]=='Glosa' or df_mk[col3][i]=='Unnamed: 0' or df_mk[col3][i]=='Unnamed: 1' or
            df_mk[col3][i]=='Unnamed: 3' or df_mk[col3][i]=='Unnamed: 4' or df_mk[col3][i]=='Unnamed: 5' or
            df_mk[col3][i]=='_____________________'):
            df_mk[col3][i]=''
