...
# pdf 경로
pdf_path="C:\\datapare\\CL\\6467.pdf"
# excel 경로
excel_path="C:\\datapare\\CL\\6467.xlsx"
...
top=(23.39*72)/25.4
left=(68.46*72)/25.4
width=(138.83*72)/25.4
height=(302.26*72)/25.4

col1=(10.84*72)/25.4+left
col2=(16.73*72)/25.4+col1
col3=(79.11*72)/25.4+col2
col4=(10.65*72)/25.4+col3
col5=(7.04*72)/25.4+col4
col6=(11.98*72)/25.4+col5
...
# 필요 : 나머지
# 불필요 : X
# 1, 5, 6페이지는 열이 7개, 가장 끝 열 삭제
def tabu(page_p):
    # 불필요 + 필요
    temp = [1, 4, 5, 6]
    # 열이 7개로 나타나는 것을 예외적으로 처리
    del_temp = [1, 5, 6]
    # pdf 파일 읽기
